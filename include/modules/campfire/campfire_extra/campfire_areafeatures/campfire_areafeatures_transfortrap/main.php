...
namespace campfire_areafeatures_transfortrap
{
	function init()
	{
	}
	function act()
	{
		...
		eval(import_module('sys','player','logger','campfire_areafeatures_transfortrap','input'));
		/*==========和田特殊功能：campfire_areafeatures_transfortrap菜单部分开始==========*/
		if($mode == 'lp_campfire_areafeatures_transfortrap')
		{
			if($command == 'menu')
			{
			...
			{
				$log.="campfire_areafeatures_transfortrap指令选择错误，如果遇到BUG，请联系管理员。<br>";
				return;
			}
			return;
		}
		/*==========和田特殊功能：campfire_areafeatures_transfortrap菜单部分结束==========*/
		$chprocess();
	}
	/*==========和田特殊功能：campfire_areafeatures_transfortrap功能部分开始==========*/
	...
	/*==========和田特殊功能：campfire_areafeatures_transfortrap功能部分结束==========*/
}
