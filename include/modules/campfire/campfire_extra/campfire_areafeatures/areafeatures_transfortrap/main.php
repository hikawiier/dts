...
namespace areafeatures_transfortrap
{
	...
	function act()
	{
		...
		eval(import_module('sys','player','logger','areafeatures_transfortrap','input'));
		/*==========和田特殊功能：areafeatures_transfortrap菜单部分开始==========*/
		if($mode == 'lp_areafeatures_transfortrap')
		{
			if($command == 'menu')
			{
			...
			{
				$log.="areafeatures_transfortrap指令选择错误，如果遇到BUG，请联系管理员。<br>";
				return;
			}
			return;
		}
		/*==========和田特殊功能：areafeatures_transfortrap菜单部分结束==========*/
		$chprocess();
	}
	/*==========和田特殊功能：areafeatures_transfortrap功能部分开始==========*/
	...
	/*==========和田特殊功能：areafeatures_transfortrap功能部分结束==========*/
}
