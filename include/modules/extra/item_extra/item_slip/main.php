...
namespace item_slip
{
	...
	$item_slip_hint = Array(
		...
		'F' => '“<span class="yellow b">「英灵殿」</span>里徘徊着这个虚拟世界曾经的搭建者们。不过，他们为什么失去了自我、变成了那种半人半代码的样子，仔细想想，恐怖极了。<br>“进入英灵殿的钥匙：<br><span class="lime b">面包 + 矿泉水 + 男生校服/女生校服</span><br>“不过，活着进去容易，要活着出来，就得看实力了。”',
		...
		'M' => '“经验之谈：刚开局时，<span class="yellow b">「属性攻击」</span>更容易快速打出伤害，助你迅速击杀「各路党派」NPC杂兵，拿下第一滴血；而中后期，下位属性攻击伤害封顶，而<span class="yellow b">「物理攻击」</span>的输出变得至关重要。<br>“在选择武器和防具时，请务必结合游戏状况来综合考虑！”',
		//N.I.K.O.似有似无的提示
		...
		'R' => '“如果你所选的卡片或者称号带有<span class="yellow b">「学习类技能」</span>，请务必注意<span class="yellow b">所学技能的解锁等级</span>，以免前期浪费技能点学了后期才生效的技能，或者后期才发现错过了能够持续生效的前期技能。<br>“此外，更换所学技能时，旧技能的「技能等级」会失去，并且不会返还技能点，因此最好对学习顺序有所规划。”',
		'S' => '“这个世界几乎没有绝对生效的事情。<br>无论是各减半类、抹消类，还是控血属性，<span class="yellow b">都有各自的失效概率</span>，而且紧要关头，失效就等于死亡。<br>“因此，在防御面差不多的情况下，谁能达到更高的血量、谁能时刻保持满血，谁的胜率就越高。<br>“无论是玩家间自卫反击，还是对抗这个世界的NPC黑幕，这个道理都是一样的。”',
		'T' => '“如果你想打遍「英灵殿」——虽然我觉得，虚拟幻境的受害者应该不会有这么触的想法吧——根据时空特使的观测，你需要准备<span class="yellow b">超过2000的血量</span>、<span class="yellow b">物抹+属抹</span>皆备的防具、<span class="yellow b">至少1项先手技能</span>，而且武器的<span class="yellow b">射程越远越好</span>（最好是不受反击的爆炸物），这样才能有一定的胜算而不是单纯送死。<br>“实际上如果你的抹消属性被打穿，那点血量根本扛不住，2000血量是为你发挥<span class="yellow b">「控血」</span>装备的最大效力而准备的。”',
		'U' => '“而如果你想大闹「SCP研究设施」——喂喂，你真的是受害者吗？——根据时空特使的观测，你需要准备<span class="yellow b">物抹+属抹+控血</span>皆备的防具，<span class="yellow b">至少1项先手技能</span>，武器的效果<span class="yellow b">至少千万数量级</span>，最好具备<span class="yellow b">物穿/属穿</span>的属性，这样才有机会在自己的防御被打穿之前，干掉1-2只那种怪物。<br>“至于生命值？拜托，如果你的双抹被打穿了，游戏中能获得的生命值简直杯水车薪啊……”',
		'V' => '',
		'W' => '',
		'X' => '',
		'Y' => '',
	...
	function mapitem_single_data_process($iname, $ikind, $ieff, $ista, $iskind, $imap, $izone){
		if (eval(__MAGIC__)) return $___RET_VALUE; 
		list($iname, $ikind, $ieff, $ista, $iskind, $imap, $izone) = $chprocess($iname, $ikind, $ieff, $ista, $iskind, $imap, $izone);
