...
$mixinfo = array
	...
	array('class' => 'wk', 'stuff' => array('曾经的荣光-深蓝','蓝宝石方块'),'result' => array('奥义『冰华⑨咲』','WKF',299,'∞','crkN'),),
	array('class' => 'wk', 'stuff' => array('奥义『冰华⑨咲』','《曾伽·宗博尔特自传》'),'result' => array('奥义『超⑨武神霸斩』','WKF',999,'∞','rkNaH'),),
	...
	array('class' => 'wk', 'stuff' => array('吼剑【地咬】','爪拳 Haab','破魔镰·断月','『雷米尔之冲击』','5.45mm 无声手枪','空想爆弹 ~ 出乎意料'),'result' => array('冲剑【虎啸】','WK',4320,250,'',),),
	array('class' => 'wk', 'stuff' => array('冲剑【虎啸】','世灭之愿','强袭之愿','CAVE社特典CD『胎慟』'),'result' => array('绝冲剑【虎王】','WK',7290,2350,'Nrd'),),
	array('class' => 'wk', 'stuff' => array('绝冲剑【虎王】','最终战术『蝎尾』'),'result' => array('绝冲大剑【神威】','WK',80000,'∞','ZNnyrdf'),),
  ...
  array('class' => 'ocg', 'stuff' => array('「电子终结龙」 ★10','「电子终结龙」 ★10','「电子终结龙」 ★10'),'result' => array('「电子天龙头」 ★10','WC10',1200,'∞','ZNnrc'),),
	...
	(
		...
		array('class' => 'wk_pr', 'stuff' => array('★女王细剑★','神之操控','安雅人体冰雕'),'result' => array('「女王蔷薇」','WK',2333,'∞','HNnrpc'),),
		array('class' => 'wk_pr', 'stuff' => array('「女王蔷薇」','■DeathNote■','悲叹之种'),'result' => array('「皇家蔷薇」','WK',7777,'∞','BNnrpc'),),
		array('class' => 'wk_pr', 'stuff' => array('「皇家蔷薇」','龙虎旗帜'),'result' => array('「猩红蔷薇」','WK',444444,'∞','BNnrfv'),),
		array('class' => 'wk_pr', 'stuff' => array('「猩红蔷薇」','『AZURE RONDO』','最终战术『神谕』'),'result' => array('「青蔷薇」','WK',1222221,'∞','BNnrkV'),),
		array('class' => 'wk_pr', 'stuff' => array('「青蔷薇」','黑？？？？'),'result' => array('「黑蔷薇」','WK',1222221,'∞','BNnrpvV'),),
		array('class' => 'wk_pr', 'stuff' => array('「黑蔷薇」','无法推卸的命运','破灭未来的残光'),'result' => array('「蔷薇凋敝之日」','WKG',2111112,'∞','LNnrypvV'),),
		...
		array('class' => 'item', 'stuff' => array('『寻熊者』','《黑熊语录》'),'result' => array('【黑熊键刃】','Y',1,1,'x'),),
		array('class' => 'item', 'stuff' => array('红之怒火','蓝之黎明','绿之顺从'),'result' => array('Way of Life','Y',1,1,'x'),),
