...
$mixinfo = array 
	...
	array('class' => 'wd', 'stuff' => array('★C4★','面具','能量核心'),'result' => array('圣诞夜惊魂','WD',325,87,'iwd'),),
  ...
  array('class' => 'ocg', 'stuff' => array('「电子终结龙」 ★10','「电子终结龙」 ★10','「电子终结龙」 ★10'),'result' => array('「电子天龙头」 ★10','WC10',1200,'∞','ZNnrc'),),
	...
	//为了便于维护，将MOD增加的合成列表移至下方。期待有更独立的解决方法。
	//篝火-回复道具
	...
	//篝火-方块系：
	array('class' => 'cube', 'stuff' => array('黑色方块','白色方块','怨灵'),'result' => array('★无极★','WP',114,514,'Nrd'),),
	array('class' => 'cube', 'stuff' => array('黑色方块','白色方块','幽灵'),'result' => array('★无极★','WP',114,514,'Nrd'),),
	);
