...
$mixinfo = array
  ...
  array('class' => 'ocg', 'stuff' => array('「电子终结龙」 ★10','「电子终结龙」 ★10','「电子终结龙」 ★10'),'result' => array('「电子天龙头」 ★10','WC10',1200,'∞','ZNnrc'),),
	...
	(
		...
		array('class' => 'wk_pr', 'stuff' => array('「皇家蔷薇」','龙虎旗帜'),'result' => array('「猩红蔷薇」','WK',444444,'∞','BNnrfcv'),),
		array('class' => 'wk_pr', 'stuff' => array('「猩红蔷薇」','『AZURE RONDO』','最终战术『神谕』'),'result' => array('「青蔷薇」','WK',1222221,'∞','BNnrkcV'),),
		array('class' => 'hidden', 'stuff' => array('「青蔷薇」','黑磨刀石'),'result' => array('「黑蔷薇」','WK',211112,'∞','BNnrcpvV'),),
		array('class' => 'wk_pr', 'stuff' => array('「黑蔷薇」','无法推卸的命运','破灭未来的残光'),'result' => array('「蔷薇凋敝之日」','WKG',2111112,'∞','LNnrcypvV'),),
