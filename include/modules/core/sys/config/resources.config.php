...
namespace sys
{
	...
	$gtinfo=array(0=>'标准模式',1=>'<font class="cyan">除错挑战</font>',2=>'<font class="orange">周五活动</font>',3=>'<font class="lime">宝石乱斗</font>',4=>'卡片模式',5=>'幻界叫唤',10=>'SOLO模式',11=>'二队模式',12=>'三队模式',13=>'四队模式',14=>'组队模式',15=>'<font class="yellow">伐木挑战</font>',16=>'<font class="green">解离模式</font>',17=>'教程模式',18=>'<font class="cyan">荣耀模式</font>',19=>'<font class="red">极速模式</font>',);
	...
	$dinfo = Array(
		...
		120 => '“呜……到此为止了吗……”<br>毒素造成的痛苦让你无法再坚持下去了。<br>你吐出嘴里最后一点深黑的血液，仰面倒了下去。<br>',
		121 => '“呜……到此为止了吗……”<br>烧伤导致的伤痛让你无法再坚持下去了。<br>你脚下一软，向前栽倒，失去了意识。<br>',
		122 => '“什么！这里竟然……”<br>专注于战斗而没能留意到陷阱的你，只能眼睁睁看着轰然启动的陷阱无情地撕碎你的身躯。<br>“怎么……战斗……也能……踩雷……”<br>你的双眼被鲜血永远地掩盖了。<br>',
	);
	...
	$stateinfo[204] = '舍身成仁';
	//死亡描述
	$dinfo[201] = '你小心的操作着机械臂，以将这爆炸物的金属外壳拆开。<br>但就在那外壳被揭开的刹那，你听到了一声轻响。<br>经历了几度厮杀的你几乎立刻明白了那意味着什么，但……这毫无意义。<br>因为在下一个瞬间，你的意识就在爆炸的冲击下灰飞烟灭了。<br>';
	$dinfo[202] = '在仔细斟酌了片刻后，你决定使用手中古怪的仪器。<br>在那一瞬间——你听到自己耳边响起了奇妙的、好似女性呢喃般的低语。<br>你抬起头，尝试找寻声音的来源，却愕然的发现自己视野所及之处仅剩一抹漆黑。<br>在你意识到自己干了什么之前，那蔓延的黑暗就将你一并吞噬了。';		
	$dinfo[203] = '你小心的操作着机械臂，以将这爆炸物的金属外壳拆开。<br>但就在那外壳被揭开的刹那，你听到了一声轻响。<br>经历了几度厮杀的你几乎立刻明白了那意味着什么，但……这毫无意义。<br>因为在下一个瞬间，你的意识就在爆炸的冲击下灰飞烟灭了。<br>……<br><span class="grey b">“想要改造「奇迹」，没有与之相匹配的「强运」可是不行的呢。话虽如此，但在这种概率下仍会改造失败的你……是「厄运」也是「强运」呢……嘻嘻嘻……”</span>';
	$dinfo[204] = '像是冥冥之中感应到了什么一般，你放下手头的工作，像一匹脱缰野马一样冲了出去。在下一刻，你突然出现，挡在了险些命丧黄泉的伙伴面前。<br>释然？痛苦？愤怒？在生命的最后一刻，出现在你脑海中的并非跑马灯，反而是因为搞不清状况而产生的无尽的困惑。<br><span class="grey b">“啧……原来这样使用队友是没法复活的吗……<br>算了你安心的去吧，下辈子我们再做好朋友！”</span><br>直到最后，你也没想明白到底发生了什么。只剩下那不知来自何人的呢喃声在你的残留的意识里不断回响……不断回响……';
*/
}
