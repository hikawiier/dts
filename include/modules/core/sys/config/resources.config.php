...
namespace sys
{
	...
	$dinfo[203] = '你小心的操作着机械臂，以将这爆炸物的金属外壳拆开。<br>但就在那外壳被揭开的刹那，你听到了一声轻响。<br>经历了几度厮杀的你几乎立刻明白了那意味着什么，但……这毫无意义。<br>因为在下一个瞬间，你的意识就在爆炸的冲击下灰飞烟灭了。<br>……<br><span class="grey b">“想要改造「奇迹」，没有与之相匹配的「强运」可是不行的呢……嘻嘻嘻……”</span>';
}
