...
namespace map
{
	...
	$xyinfo[98]='DE-VAzS';
	//地图描述
	$areainfo[98]="一望无垠的平原上，如今遍布着大小惊人的坑洼。虽有野花在不远处盛开，却掩盖不住从这片死土中渗出荒凉寂寥之感……<BR>呆在这里只会让人感觉到不舒服，还是赶紧离开吧。<BR>";
	//全部隐藏地图列表（注意：在$plsinfo中，隐藏地图的序号一定要排在非隐藏地图后面，否则会出BUG，推荐使用从98开始的倒序，无效的地图不要写在列表里，否则也会出BUG） 
	$hidden_arealist = Array(94,95,96,97,98);
